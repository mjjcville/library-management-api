...
t.datetime "created_at", null: false
t.datetime "updated_at", null: false
t.index ["library_id", "user_id"], name: "index_borrowers_on_library_id_and_user_id", unique: true
...
t.datetime "created_at", null: false
t.datetime "updated_at", null: false
t.index ["first_name", "last_name", "credit_card_number", "credit_card_expiration", "credit_card_security_code"], name: "idx_on_first_name_last_name_credit_card_number_cred_6d9821a090", unique: true
  end
